...
def test_ensure_binary_downloads_and_verifies(tmp_path, monkeypatch):
    ...
    url_archive = f"https://github.com/Artyom-vv/invisible_playwright/releases/download/{BINARY_VERSION}/{asset}"
    url_sums = f"https://github.com/Artyom-vv/invisible_playwright/releases/download/{BINARY_VERSION}/checksums.txt"
...
def test_parse_owner_repo_valid():
    owner, repo = _parse_owner_repo(
        "https://github.com/Artyom-vv/invisible_playwright/releases/download/x/y"
    )
    assert owner == "Artyom-vv"
